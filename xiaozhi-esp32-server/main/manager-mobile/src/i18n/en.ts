...
export default {
  ...
  // About us
  'settings.aboutApp': 'About AyaPonsX Console',
  'settings.aboutContent': 'AyaPonsX Console\n\nA cross-platform mobile management app built with Vue.js 3 + uni-app, providing device management, agent configuration and other functions for ESP32 smart hardware.\n\n© 2025 2026 AYA Cloud SAS {version}',
