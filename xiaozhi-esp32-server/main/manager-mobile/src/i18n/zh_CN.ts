...
export default {
  ...
  // 关于我们
  'settings.aboutApp': '关于AyaPonsX智控台',
  'settings.aboutContent': 'AyaPonsX智控台\n\n基于 Vue.js 3 + uni-app 构建的跨平台移动端管理应用，为ESP32智能硬件提供设备管理、智能体配置等功能。\n\n© 2026 AYA Cloud SAS {version}',
